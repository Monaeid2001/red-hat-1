...
# 16-a: Change the permissions of oldpasswd file to give owner read and write permissions and for group write and execute and execute only for the others
# (using chmod in 2 different ways)
![Q16-a-lab2](https://github.com/Monaeid2001/red-hat-1/assets/104376815/5bd94092-f67a-4db7-8d92-e3d05d24c689)
# 16-b: Change your default permissions to be as above. What is the maximum permission a file can have, by default when it is just
